...
public class TextObj implements ScreenObj {
	...
	public TextObj(String txtInit, float fontSizeInit, float maxWidth,
			ScreenPainter dw, boolean underline) {
	...
	private void prepTxt(String txtInit, float fontSizeInit, float maxWidth, ScreenPainter dw) {
		...
		/* NH:
		 * This code is useful for breaking up lines based on their width,
		 * which is something that I don't want to do for my purposes, but
